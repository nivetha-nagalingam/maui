...
public class Issue2681 : TestNavigationPage
{
	...
	{
		PushAsync(new ContentPage() { Title = "Freeze Test", Content = new Button() { AutomationId = "ClickMe" , Text = NavigateToPage, Command = new Command(() => this.PushAsync(new FreezeMe())) } });
	}
